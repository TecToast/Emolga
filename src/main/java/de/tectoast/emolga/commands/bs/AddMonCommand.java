...
public class AddMonCommand extends Command {
    public AddMonCommand() {
        super("addmon", "`!addmon <pokemon> <Ball>` Trägt ins Tauschdokument ein, dass du dieses pokemon in diesem Ball hast", CommandCategory.BS);
    }
