...
suspend fun PokemonDisplayService.getDisplayName(
    showdownId: ShowdownID,
    draftRunContext: DraftRunContext,
    withAdditionalEnglish: Boolean = false
) =
    getDisplayName(
        showdownId,
        draftRunContext.league.guild,
        draftRunContext.tierlistMeta.language,
        withAdditionalEnglish
    )