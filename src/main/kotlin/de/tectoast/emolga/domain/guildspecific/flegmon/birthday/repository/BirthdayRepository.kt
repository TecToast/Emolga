package de.tectoast.emolga.domain.guildspecific.flegmon.birthday.repository

import de.tectoast.emolga.domain.guildspecific.flegmon.birthday.model.Birthday
...
@Single
class BirthdayRepository(private val db: R2dbcDatabase) {
    /**
