...
@Single
class AlwaysTimerSkipModeHandler : TimerSkipModeHandler<TimerSkipMode.During.Always> {
    override val targetClass = TimerSkipMode.During.Always::class

    override suspend fun afterPick(
        c: TimerSkipMode.During.Always, ctx: DraftRunContext, data: NextPlayerData
    ): TimerSkipData {
    ...
    override suspend fun getPickRound(c: TimerSkipMode.During.Always, ctx: DraftRunContext) =
