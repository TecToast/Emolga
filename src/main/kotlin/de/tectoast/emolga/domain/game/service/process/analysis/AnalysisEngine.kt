...
import de.tectoast.emolga.domain.game.model.analysis.PlayerSaveKey
...
sealed class SDEffect(vararg val types: String) {
    ...
    data object Win : SDEffect("win") {
        ...
        override fun execute(split: List<String>) {
            val indexOfWinner =
                context.sdPlayers.indexOfFirst { it.nickname.toShowdownUserId() == split[1].toShowdownUserId() }
