...
public class TranslationsManager extends DataManager {
    ...
    public ResultSet getTranslation(String name, String mod) {
        String id = Command.toSDName(name);
        ...
        return Database.select(selectAll(
                and(
                        or(ENGLISHID.check(id), GERMANID.check(id)),
    ...
    public void addNick(String nick, Command.Translation t) {
        insert(nick, nick, t.getOtherLang(), t.getTranslation(), t.getType().getId(), "default", true, null);
    }
